...
extension Terminator {
  ...
  public static var end: Terminator {
    return .suffix("")
  }

  /// Match an ending prefix of a string.
  public static func suffix(_ string: String) -> Terminator {
    return Terminator(string: string, isSuffix: true)
  }

  /// Match against a string located anywhere within the scanned string.
  public static func anyString(_ string: String) -> Terminator {
...
extension StringProtocol where SubSequence == Substring {
  ...
  public func firstSubstring(
    between identifiers: [Identifier],
    and terminators: [Terminator]
  ) -> Substring? {
    var match: Substring?
  ...
  public func scan(using matchers: [Matcher]) {
    ...
    for index in indices {
      let noSessionsRemain =
        (activeSessions.isEmpty && partialSessions.isEmpty && idleMatchers.isEmpty)
